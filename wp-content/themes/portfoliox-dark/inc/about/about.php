	...
	<div class="mgadin-hero">
		<div class="mge-info-content">
			...
			<div class="mge-info-desc">
				<div><?php printf(esc_html__('Now You are using the Free version of %1$s theme.', 'portfoliox-dark'), $current_theme_name); ?></div>
				<div><?php printf(esc_html__('%1$s PRO version is now available with an auto-setup feature!! Only active the theme and follow auto-setup then your site will be ready with lots of advanced features. Now create your site like a pro without any coding knowledge. Need only a few clicks!!!! So why late get pro now ', 'portfoliox-dark'), $current_theme_name); ?></div>
			</div>
...
{
	global $pagenow;
	$pxdinfo_date = get_option('portfoliox_dark_note');
...
function portfoliox_dark_new_optins_texts_init()
{
	...
	if (isset($_GET['xbnotice']) && $_GET['xbnotice'] == 1) {
		update_option('portfoliox_dark_note', current_time('mysql'));
	}
}
